...
static void JNICALL ClassFileLoadHook(
    ...
    if (strncmp(name, "java/", 5) == 0 ||
        ...
        strncmp(name, "io/yamsergey/adt/sidekick/jvmti/", 32) == 0) {
        return;
    }
...
static bool initJavaCallbacks(JNIEnv* env) {
    jclass agentClass = env->FindClass("io/yamsergey/adt/sidekick/jvmti/JvmtiAgent");
...
Java_io_yamsergey_adt_sidekick_jvmti_JvmtiAgent_nativeRegisterTransformerHook(
        JNIEnv* env,
        jclass clazz) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_yamsergey_adt_sidekick_jvmti_JvmtiAgent_nativeAddHookTarget(
        JNIEnv* env,
        jclass clazz,
        jstring className,
        jstring methodName,
...
extern "C" JNIEXPORT void JNICALL
Java_io_yamsergey_adt_sidekick_jvmti_JvmtiAgent_nativeRetransformClasses(
        JNIEnv* env,
        jclass clazz,
