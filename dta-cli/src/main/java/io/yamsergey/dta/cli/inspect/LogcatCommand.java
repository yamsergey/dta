...
import io.yamsergey.dta.tools.android.inspect.LogcatCapture;
 ...
 * <pre>
 * # Capture all logs
 * dta-cli inspect logcat
 *
 * # Save to file
 * dta-cli inspect logcat -o logcat.txt
 *
 * # Capture last 500 lines
 * dta-cli inspect logcat --lines 500
 *
 * # Capture only errors and warnings
 * dta-cli inspect logcat --priority W
 *
 * # Clear logs first, then capture
 * dta-cli inspect logcat --clear -o logcat.txt
 *
 * # Filter by tag
 * dta-cli inspect logcat --tag "ActivityManager:I *:S"
 *
 * # Capture from specific device
 * dta-cli inspect logcat -d emulator-5554 -o logcat.txt
 * </pre>
 */
@Command(name = "logcat",
