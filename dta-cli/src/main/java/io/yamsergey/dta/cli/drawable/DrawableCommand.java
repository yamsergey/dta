package io.yamsergey.dta.cli.drawable;

import io.yamsergey.dta.tools.android.vector.VectorDrawableConverter;
 ...
 * dta-cli drawable -i ic_launcher.xml -o ic_launcher.png
 *
 * # Convert with custom size
 * dta-cli drawable -i ic_launcher.xml -o ic_launcher.png -w 1024 -h 1024
 *
 * # Convert with density-based sizing
 * dta-cli drawable -i ic_launcher.xml -o ic_launcher.png --density xxxhdpi
 * </pre>
 */
