...
import io.yamsergey.dta.tools.android.inspect.Screenshot;
import io.yamsergey.dta.tools.android.inspect.ScreenshotCapture;
 ...
 * dta-cli inspect screenshot
 *
 * # Save to specific file
 * dta-cli inspect screenshot -o screenshot.png
 *
 * # Capture from specific device
 * dta-cli inspect screenshot -d emulator-5554 -o screen.png
 *
 * # Specify custom ADB path
 * dta-cli inspect screenshot --adb-path /custom/path/to/adb -o screen.png
 * </pre>
 */
